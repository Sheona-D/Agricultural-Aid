package com.example.shilpika.myapplication.widget;
...
import com.example.shilpika.myapplication.service.LocationUpdateService;
import com.example.shilpika.myapplication.utils.AppPreference;
import com.example.shilpika.myapplication.utils.AppWidgetProviderAlarm;
...
public class MoreWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intentStartActivity = new Intent(context, Main2Activity.class);
